...
\begin{figure}[tbp]
  ...
  \begin{tikzpicture}[]
    ...
    \node[nonterminal] (stmt) at ([yshift=-\spacing]pgm.south) {stmt};
    ...
    \node[terminal] (params value)   at ([yshift=-\spacing]params.south) {\texttt{"Hello, World!"}};
