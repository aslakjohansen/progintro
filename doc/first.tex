...
\begin{itemize}
  \item \filename{new\_project.csproj}: This is a \say{project} file. It holds metadata that tells the \commandname{dotnet} command how to build the project. % TODO: add an exercise for determining which version of the framework dotnet should use
