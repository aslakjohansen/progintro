...
% livebook
Like Python, Elixir code can run in notebook form. Unlike Python, we will actually be using this later on. So, lets see what it looks like in Livebook, the Elixir application for editing and executing notebooks.
