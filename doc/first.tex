...
% the literal token
Another example is \texttt{STRING} (also called a \idx{string literal}{Literal!String}). This is a sequence of arbitrary characters surrounded by quotes. This is a gross simplification. But for now, we don't have to worry about the details. Those worries can wait until section \ref{sec:io:strings}.
