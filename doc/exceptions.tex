...
Knowing that Python uses indents rather than curly braces for blocks, you can probably come up with a good guess for what exception handling looks like in this language. And you would be almost correct; the main difference is that python uses a different names for the keywords \keywordname{catch} and \keywordname{throw}. It looks like this:
