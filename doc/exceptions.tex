...
% motivation: it makes sense to think of a try-catch construct as us try out something, but it is not a rollback, any side-effects caused from within the try block will "spill out", accordingly we may end up with the side-effects of a partially evaluated try block
