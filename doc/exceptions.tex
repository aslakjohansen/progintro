...
Knowing that \idx{Python}{Python programming language} uses \idx{indents}{Indentation} rather than curly braces for blocks, you can probably come up with a good guess for what exception handling looks like in this language. And you would be almost correct; the main difference is that python uses a different names for the \idx{keywords}{Keyword} \keywordname{catch} and \keywordname{throw}. It looks like this:

% example: reuse a previous example
\inputminted[firstline=3]{python}{../src/python/exceptions/catching/catching.py}
