...
The \idx{\keywordname{defer}}{defer@\keywordname{defer} statement} line will make more sense when you get to section \ref{io:files} that explains how to work with files. For now, just accept that (i) files that have been opened for access should be closed again, (ii) this line makes sure that whenever the surrounding function returns then the file is closed (and the resources associated with it being open are released).
