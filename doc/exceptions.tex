...
% intro: we have been focusing on the specific type of exception called Exception, but the truth is that there are more than one exception type, as they all behave the same there is little need to dive deeper into them at this point, in section \ref{sec:inheritance:exceptions} we will explore why they behave the same, for now we will simply show how we can have type-specific handling sites, it looks like this:
