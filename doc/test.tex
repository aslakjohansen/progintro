...
Six million components that need to work together. That certainly is a lot of complexity. But, if we look past the fact that these components still need to work together as they age, these are actually quite small numbers compared to what we see in software. Not that this can ever be an apples-to-apples comparison.
