...
This section gets fairly dark. Consider yourself warned. There is no point in having our perception of reality deviate from the trajectory of the \idx{planet}{Planet}. If we are to avoid a total collapse of the \idx{societies}{Society} that we know today then we need to accept where we are headed and actively take steps to change direction of a complex of issues. A \idx{moonshot}{Moonshot} is necessary, and it will need effort, focus and resources like no other project in \idx{history}{History}.
