...
% history of efficiency: need (slow hardware), carelessness (moore's law, evolution of performance per price), internet (shifting code to the clients electrical bill), mobile (same), developer price becomes driving parameter of software development, production is messy and power consuming, so are data centers and networks
