...
% high abstraction as low-hanging fruit
...
\begin{itemize}
  ...
  \descitem{Level 3 \say{Developer Literate}:} Capable of operating a general purpose operating system as a software developer. This includes having an understanding of environment variables, standard streams, the terminal, the processor and the memory hierarchy, and programming language syntax.
\end{itemize}
