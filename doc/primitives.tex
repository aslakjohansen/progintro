...
\begin{enumerate}
  \descitem{Zeroes:} Any float with a normalized mantissa of zero and a biased exponent of zero is a zero value. The only thing left is the sign bit, and accordingly we have a positive and a negative zero. These two values are equal by definition.
  \descitem{Infinities:}
  \descitem{NaN:}
\end{enumerate}
