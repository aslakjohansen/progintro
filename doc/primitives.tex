...
\begin{enumerate}
  ...
  \descitem{Infinities:} Any float with a normalized mantissa of zero and a biased exponent of all ones represent infinity ($\infty$). The sign bit is used to differentiate between $\infty$ and $-\infty$.
  \descitem{NaN:}
\end{enumerate}
