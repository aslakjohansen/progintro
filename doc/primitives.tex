...
% but what is behind that term (lossless)?, can you round-trip it?, an explicit cast is necessary if we risk loosing data, example, by casting we tell the compiler that we take on the responsibility of this risk, "trust me, bro!"
