...
% intro
Modern processors support operations om floating point numbers that follow the \idx{IEEE-754}{IEEE-754} standard. These are commonly referred to as IEEE (pronounced I-tripple-E) floats. This standard covers the representation of the numbers and definitions of how certain operations work on them.
...
% special values: there are special values (inf, -inf, NaN), their encodings,

% key takeaway: ieee floats are not exact, they consists of a sign an exponent and a mantissa, if one of the exponent/mantissa is not large enough then you need a larger float size, while they have different encoding 0==-0
