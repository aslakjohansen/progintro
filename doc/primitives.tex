...
Basic math tells us that $2+3*4=2+(3*4)=14$ as opposed to $(2+3)*4=24$. This is because we have agreed on the rule that the multiplication operation binds tighter than the addition addition operation. Similar rules exist for expressions in programming languages. Just as we learned that $2+3*4=2+(3*4)$, we ned to learn how tightly each of the operators (we make use of while programming) bind.
