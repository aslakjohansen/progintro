...
\begin{itemize}
  ...
  \descitem{XOR Operator} A hat charactor is an \idx{infix}{infix} XOR operator. \\
    Example: \texttt{sunken || afloat} should be read as \say{sunken xor afloat} (as in, it cannot be both).
...
% introduce syntax: new concept (cond), a cond is an expr that evaluates to a boolean value
