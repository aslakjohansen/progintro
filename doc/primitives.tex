...
% intro: the code we write consists of a sequence of characters, C# till interpret this, we need to understand how it does this, otherwise how can we hope to "communicate" correctly with it?

% parsing: in this section we have introduced the notion of an expression, expressions are made up of operators, lets take a look at how expressions are parsed, that is: how a sequence of characters at a position in out code where the compiler expects an expression is translated into a parse tree
