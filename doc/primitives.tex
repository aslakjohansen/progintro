...
\begin{syntaxfloat}
  \begin{syntax}{expr}
%    \node[nonterminal] (symbol)  at (0,\SyntaxRow{0}) {expr};
%    \node[empty]       (begin)   at (2cm,\SyntaxRow{0}) {};
...
%    \node[empty]       (end)     at (10cm,\SyntaxRow{0}) {};
    
%    \SyntaxPathForward{begin}{ruleIa}
%    \SyntaxPathForward{ruleIa}{ruleIb}
%    \SyntaxPathForward{ruleIb}{ruleIc}
%    \SyntaxPathForward{ruleIc}{end}
%    \begin{syntaxrule}{begin}
%      \SyntaxForwardPathTo{ruleIa}
%      \SyntaxForwardPathTo{ruleIb}
%      \SyntaxForwardPathTo{ruleIc}
%      \SyntaxForwardPathTo{end}
%    \end{syntaxrule}
