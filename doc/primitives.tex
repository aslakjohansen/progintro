...
% rule: an explicit cast is necessary if we risk loosing data (can you round-trip it?), example, by casting we tell the compiler that we take on the responsibility of this risk, "trust me, bro!"
