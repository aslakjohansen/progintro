...
% grouping: most languages define a hierarchy of operators, operators at the top level of the hierarchy binds the strongest and operators and to bottom level binds the weakest, within a givel level all operators are treated as binding equally strong and the parsing is dictated on the associativity of the level (see next section)
