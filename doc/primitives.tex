...
\begin{itemize}
  \descitem{NOT} Whether a value is not true (aka whether it is false).
  \descitem{AND} Whether two values are both true.
  \descitem{OR} Whether at least one of two values is true.
  \descitem{XOR} Whether exactly one of two values is true.
\end{itemize}
...
% TODO: placing the introduction of the mathematical symbols
