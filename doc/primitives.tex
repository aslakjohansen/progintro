...
\begin{itemize}
  \descitem{NOT} Whether a value is not true (aka whether it is false). It is written as $\neg a$.
  \descitem{AND} Whether two values are both true. It is written as $a \wedge b$.
  \descitem{OR} Whether at least one of two values is true. It is written as $a \vee b$.
  \descitem{XOR} Whether exactly one of two values is true. It is written as $a \oplus b$.
\end{itemize}
