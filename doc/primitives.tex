...
% execution speed: most (if not all) of these casts takes a bit of time, the representation has to change so that the observed rules (e.g., overflow) will apply, it's not a lot of time, in fact it is so little that we usually don't care about it at all
