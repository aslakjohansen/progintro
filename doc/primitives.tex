...
% reason[loss of data]: explicit/implicit cast, when loss of data is a risk (based purely on types and not actual data) then an explicit cast is needed, it is our way of telling the compiler that we take responsibility, trust me bro!
