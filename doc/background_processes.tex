...
Examples of desktop environments include Microsoft Windows, Apple OSX, Gnome and KDE. The latter two are popular choices on Linux, but there are many other options.
