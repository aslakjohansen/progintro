...
Most commands will \idx{accept}{Accept!Argument} a \highlight{\texttt{--help}} and/or \highlight{\texttt{-h}} argument and react to it by printing out a help message instead of completing the operation it was designed to do.
