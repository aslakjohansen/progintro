...
Let's look into what happens when you open a file in your file mananger. Do you know? First, the file type is determined. How this is done depends on the sprcific file manager, but once the system knows the type of the file, it will use that to look up the default program for handling this type of file. Once it knows which program should handle it, it will locate the executable of that program and start it with the path to the chosen file as a parameter.
