...
\begin{itemize}
  \item A working directory (see section \ref{bg:fs:paths}).
  \item A list of parameters. This is the primary means of conveying what concrete task the invoked process should perform.
  \item An environment. This is a mapping from strings to strings. Certain keys have well-defined roles. One of the most important keys will be covered in the following paragraph.
\end{itemize}
