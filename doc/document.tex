...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=south west] () at ([yshift=\linedist]left) {\scalebox{\textscale}{\Huge{\textcolor{white}{\thetitle}}}};
  \node[anchor=north east] () at ([yshift=-\linedist]right) {\scalebox{\textscale}{\Large{\textcolor{white}{\theauthor}}}};
  
  \node[anchor=center] () at ([yshift=-183mm*5/4]current page.north) {\scalebox{\textscale}{\Large{\textcolor{white}{some date}}}};
\end{tikzpicture}
\newpage
