...
% generics fix: core problem (LineSegment needs endpointA to have a declared type through which DistanceTo is defined with a parameter of the same type while at the same time decouple LineSegment from the specific Point variant)
