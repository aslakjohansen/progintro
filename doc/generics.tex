...
The C preprocessor supports a suite of directives. Such directives appears in the code at the beginning of a line and starts with a hashtag. Lets take a look at a few of these directives:
\begin{itemize}
  \item Macros can be defined with \directivename{define}. The process of replacing every occurrence of them is referred to as macro expansion.
  \item We can branch on the definition (or lack thereof) with \directivename{ifdef} and \directivename{ifndef}. Such a branch is ended using \directivename{endif}.
  \item The contents of another file can be injected using \directivename{include}.
\end{itemize}
