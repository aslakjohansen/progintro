...
By now, we have already seen what a parameterized class looks like in \csharp. Syntax \ref{syntax:generics:support} and \ref{syntax:generics:classes} formalizes this.
