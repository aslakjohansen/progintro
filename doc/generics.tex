...
% there is another way though, that is to create a parameterized (or generic) type, define recipe (take class or interface as starting point, insert placeholders for needed types, declare these placeholders as parameters to the type you are defining)

% compiler: then the compiler will automatically generate concrete type variants on demand
