...
\begin{itemize}
  \item Macros can be defined with \directivename{define}.
...
% macros: these are sometimes referred to as macros, macro expansion, lets look at two examples

% 1st example: in the first example three definitions are involved (DEFAULT, RADIUS2DIAMETER and MULTIPLIER), the two first are defined in the source itself, one is parameterized and one is not, the last definition is provided compiletime as an instruction to the compiler
