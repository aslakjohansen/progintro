...
There is an underlying pattern here: We have one or more trivial cases and a recursion step tat solution-wise brings us closer to those base cases. When a function calls itself in order to solve a subproblem, we say that the function is recursive. Recursion is a form of repetition and can -- in some cases -- be a valid or even superior alternative to loops.
