...
The primary interface of a function consists of its inputs and outputs. Functions can, however, also have \textsl{side-effects}. Side-effect is an umbrella term that covers every other effect. That is, how it affects the part of the world that is external to it. Examples of this include:
\begin{itemize}
