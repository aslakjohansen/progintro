...
% contract
Together, these three interfaces make up a contract. The input and output interfaces are hard elements that are enforced by the compiler. While developers may rely on the side-effect interface (and document it), most languages (\csharp\ included) offer no enforcement.
