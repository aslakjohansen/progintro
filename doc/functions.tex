...
% intro: python is a scripting language, these are generally weakly typed and so is python, this means that (), accordingly function declarations do not declare parameter or return types, in python functions are declared using the def keyword:
