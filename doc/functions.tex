...
% reusable part: print
The \funcname{intlist\_print} function is fairly straight forward. Lines 49 and 51 iterate through the list (which is \valuename{null} terminated). For each iteration, the payload is printed along with a single space character. On lines 48 and 53 some visual \textsl{wrapping characters} are printed, and only the last print statement breaks the line.
