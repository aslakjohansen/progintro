...
% intro: functions can be nested, what that means, why would you do this? structure (if the function is only meant to be called from within this particular other function), scope nesting (if the function is simpler to write if it gets access to the function-local scope of the calling function)
