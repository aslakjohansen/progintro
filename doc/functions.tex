...
We will start this section with a minor digression. In mathematics, the Fibonacci sequence was originally described by Indian mathematicians (e.g., by Acharya Pingala -- पिङ्गल -- around 200 BC\cite{towards_a_global_science}) but today we know it through the name of Fibonacci (aka Leonardo of Pisa) who rediscovered it in 1202. This particular sequence appears unexpectedly often in mathematics and nature, and is related to the golden ratio. It has even found its way into music\cite{tool_lateralus}. Formally, we can define the sequence as:
