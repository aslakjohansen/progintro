...
Often, you will see a small series of such guards -- each rejecting a spacial case -- and then comes the actual implementation of the function. It is good style to lead each guard with a comment explaining (i) that it is a guard, and (ii) which guarantees it provides.
