...
% intro: looking at this definition there is no obvious way of implementing the function using branches loops and our basic datastructures, but once you \textsl{get} the idea it is trivial to implement using function calls, that is function calls to itself, one way of so looks like this:
