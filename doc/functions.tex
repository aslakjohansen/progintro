...
Functions -- especially when combined with data structures -- can be used to build higher-level \idc{abstractions}{Abstraction}. One example of this is the \idx{linked list}{List!Linked} from section \ref{sec:primdata:sequence:list}. Figure \ref{fig:fun:case:list} implements a linked list of integers with support for a number of convenient \idx{operations}{Operation}. These are:
