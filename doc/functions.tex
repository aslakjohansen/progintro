...
% usage
Now that we have the datastructure and functionality in place, we can start writing code that actually makes use of it. Here's an example of what we can do with it:
