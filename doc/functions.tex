...
We will start this section with a minor digression. In mathematics, the \defi{Fibonacci sequence}{Fibonacci sequence} was originally described by Indian mathematicians (e.g., by \idx{Acharya Pingala}{Pingala, Acharya पिङ्गल} -- पिङ्गल in \idx{Sanskrit}{Sanskrit}-- around 200 BC\cite{towards_a_global_science}) but today we know it through the name of Fibonacci (aka \idx{Leonardo of Pisa}{Leonardo of Pisa}) who rediscovered it in 1202. This particular sequence appears unexpectedly often in mathematics and nature, and is related to the \idx{golden ratio}{Golden ratio}. It has even found its way into music\cite{tool_lateralus}. Formally, we can define the $n$'th element of the sequence as:
