...
The individual staments are evaluated one at a time, in the context of the program state resulting from the previous statement. So, whichever way we go throught the sequence of the \say{track}, we will only have access to the declarations from the common \textsl{ancestor} statements. Those are the statements that you are guaranteed to have passed through at this point.
