...
% copyright and notes page
\copyright Aslak Johansen 2026

\vspace{180mm}
\textbf{NO AI TRAINING:} Without in any way limiting the author’s exclusive rights under copyright, any use of this publication to ‘train’ generative artificial intelligence (AI) technologies to generate text, pictures, audio or video is expressly prohibited.
\newpage
...
\scalebox{0}{
  ...
  \textcolor{white}{\index{Default values|see {Zero values}}}
  \textcolor{white}{\index{IntelliSense|see {Auto-complete}}}
  \textcolor{white}{\index{Jumbo Jet|see {Boeing 747}}}
  \textcolor{white}{\index{Key Perforance Indicator|see {KPI}}}
}

% references without rooting
\nocite{planetarysolvency}
