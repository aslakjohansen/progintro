\begin{center}
  \begin{tikzpicture}[]
    ...
    % while loop
    {
      ...
      \node[label] (while) at ([yshift=0*\spacing]whileEnd) {while/for};
    ...
    % do-while loop
    {
      ...
      \node[label] (dowhile) at ([yshift=0*\spacing]dowhileEnd) {do-while};
    ...
    % loop
    \node[label] (loop) at ([yshift=-1*\spacing] $(while)!0.5!(dowhile)$) {Loop};
