\begin{center}
  \begin{tikzpicture}[]
    ...
    % sequence
    {
      ...
      \node[label] () at ([yshift=0*\spacing]seqEnd) {\small Sequence};
    ...
    % conditional
    {
      ...
      \node[label] (cond) at ([yshift=0*\spacing]condEnd) {\small Conditional};
    ...
    % fork
    {
      ...
      \node[label] (fork) at ([yshift=0*\spacing]forkEnd) {\small Fork};
...
%    }
    ...
    % while loop
    {
      ...
      \node[label] (while) at ([yshift=0*\spacing]whileEnd) {\small Skippable Loop};
    ...
    % do-while loop
    {
      ...
      \node[label] (dowhile) at ([yshift=0*\spacing]dowhileEnd) {\small Non-Skippable Loop};
