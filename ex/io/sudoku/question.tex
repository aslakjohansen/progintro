...
This is an example of a file format called Scalable Vector Graphics (\idx{SVG}{SVG}). It is the only format for vector graphics that is widely supported on websites. The above is just a small sample of what you can do in SVG.
