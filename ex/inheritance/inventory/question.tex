...
Make in your own \methodname{Main} method an array that can hold 10 \typename{FoodItem} objects. Use a loop to add a \typename{FoodItem} object to each element in this array.
