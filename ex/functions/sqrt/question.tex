...
\begin{enumerate}
  \item A function called \funcname{sqrt} is defined that calculates the square root of its input (of type \typename{double}) to a precision of a specific (e.g., 7) number of decimals.
    \begin{itemize}
